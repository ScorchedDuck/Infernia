package net.scorchedduck.infernia.item.custom;
...
public class ChiselItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (CHISEL_MAP.containsKey(clickedBlock)) {
            if(!level.isClientSide()) {
                ...
                level.playSound(null, context.getClickedPos(), ModSounds.CHSIEL_USE.get(), SoundSource.BLOCKS);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        if (Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("tooltip.inerfnia.chisel.shift_down"));
        } else {
